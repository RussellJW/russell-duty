    ...
    for k,v in pairs(Config.Jobs) do
		...
		if job == offjob then
			xPlayer.setJob(onjob, grade)
			 DiscordWebhook(xPlayer, Config.Bot["Name"], Config.Bot["Image"],name.." **is on duty.**")
		else
		end
	end
...
AddEventHandler('russell-duty:offduty', function(job)
    ...
    for k,v in pairs(Config.Jobs) do
		...
		if job == v then
		 ...
		 DiscordWebhook(xPlayer, Config.Bot["Name"], Config.Bot["Image"],name.." **is off duty.**")
		else
		end
	end
...
AddEventHandler('russell-duty:unemployed', function(job)
	...
	local name = GetName(_source)
		 ...
		 DiscordWebhook(xPlayer, Config.Bot["Name"], Config.Bot["Image"],name.." **signed resignation.**")
	end)
